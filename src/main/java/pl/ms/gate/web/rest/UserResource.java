...
import pl.ms.gate.service.MailService;
import pl.ms.gate.service.UserService;
import pl.ms.gate.service.dto.AdminUserDTO;
import pl.ms.gate.web.rest.errors.BadRequestAlertException;
import pl.ms.gate.web.rest.errors.EmailAlreadyUsedException;
import pl.ms.gate.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link pl.ms.gate.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
