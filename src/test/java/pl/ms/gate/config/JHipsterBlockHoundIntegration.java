...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("pl.ms.gate.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("pl.ms.gate.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
